        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.show.index')" :active="request()->routeIs('admin.show.index')">
                        {{ __('Шоу - программа') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.feedback.index')" :active="request()->routeIs('admin.feedback.index')">
                        {{ __('Отзывы') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.question.list')" :active="request()->routeIs('admin.question.list')">
                        {{ __('Вопросы') }}
                    </x-nav-link>
